...
const DentRemovalData = {
  ...
  // ─── PRICING SECTION ─────────────────────────────────────
  pricing: {
    subheading: "Pricing depends on the size and complexity of the dent.",
    plans: [
      {
        title: "Small",
        description: "Minor dings & door dents.",
        priceFrom: "60",
        priceTo: "100",
        duration: "| ~1–2 hrs",
        popular: false,
        features: [
          ...
          "Specialist PDR tools",
          "Final quality inspection",
        ],
      },
      {
        title: "Medium",
        description: "Larger panel dents.",
        priceFrom: "100",
        priceTo: "200",
        duration: "| ~half day",
        popular: true,
        features: [
          "Multi-point dent removal",
          "Panel reshaping",
          "Specialist PDR tools",
          "Final quality inspection",
        ],
      ...
      {
        title: "Large",
        description: "Extensive or deep damage.",
        priceFrom: "200",
        duration: "| POA",
        popular: false,
        features: [
