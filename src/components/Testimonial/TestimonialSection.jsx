...
const TestimonialsSection = () => {
  return (
    <section id="testimonial" className="bg-[#08060F] px-4 py-1 transition-colors">
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-10 items-center">
        ...
        <div data-aos="fade-right">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold mb-4 leading-snug text-white">
            THOUSANDS OF <br />
            <span className="text-transparent bg-clip-text bg-linear-to-r from-[#7C2FC0] via-[#D4187A] to-[#FF6D00]">HAPPY CUSTOMERS</span>
          </h2>
