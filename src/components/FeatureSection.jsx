  ...
  return (
    <div className="bg-[#08060F] text-[#B8C0CC] selection:bg-[#FF6D00] selection:text-black">
      ...
      <header className="py-24 px-8 md:px-20 border-b border-white/5">
        <h1 className="font-['Bebas_Neue'] text-7xl md:text-8xl text-white leading-none">
          Features of <span className="text-transparent bg-clip-text bg-linear-to-r from-[#7C2FC0] via-[#D4187A] to-[#FF6D00]">Our Products</span>
        </h1>
      </header>
